        ...
        <div className="grid grid-cols-1 gap-8">
          <div className="bg-gray-50 dark:bg-zinc-900 rounded-[3rem] p-10 border border-black/5 dark:border-white/5 relative overflow-hidden shadow-sm">
            <div className="relative z-10">
              ...
              <button className="w-full md:w-auto px-12 py-5 bg-[#0088cc] text-white rounded-full font-bold flex items-center justify-center gap-4 shadow-xl shadow-blue-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
